...
<body>
    ...
    {       
        ...
        $sql = "INSERT INTO `leave_and_license_agreement`(`approval`,`email`,`firstPartyName`, `firstPartyAddress`, `secondPartyName`, `secondPartyAddress`, `photo` ,`noOfMonths`, `startDate`, `endDate`, `rent`, `rentxmonths`, `deposit`, `total`) VALUES ('$approval','$email','$firstPartyName','$firstPartyAddress','$secondPartyName','$secondPartyAddress','$folder','$ContractLength','$LiveDate','$EndDate','$rent','$rentxmonths','$deposit','$total')";
        $mysqli->query($sql);
