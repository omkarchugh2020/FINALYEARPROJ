...
<body>
    ...
    {       
        ...
        $sql = "INSERT INTO `promisory_note`(`email`,`approval`,`firstPartyName`, `firstPartyAddress`, `secondPartyName`, `secondPartyAddress`, `noOfMonths`, `startDate`, `endDate`, `rupees`,`withinterset`,`witness_name`) VALUES ('$email','$approval','$firstPartyName','$firstPartyAddress','$secondPartyName','$secondPartyAddress','$ContractLength','$LiveDate','$EndDate','$rupees','$withinterset','$witness_name')";
        $mysqli->query($sql);
        header("location:promisory_note.php");
