...
<body>
    ...
    { 
        ...
        $sql = "INSERT INTO `property_transfer`( `email`,`approval`,`firstPartyName`,`firstPartyAddress`, `secondPartyName`, `secondPartyAddress`, `selling_date`, `area`, `cost`, `stampduty`, `total`) VALUES ('$email','$approval','$firstPartyName','$firstPartyAddress','$secondPartyName','$secondPartyAddress','$selling_date','$area','$cost','$stampduty','$total')";
        $mysqli->query($sql);
    ...
    ?>
    <p align="right">
<input type="button" onclick="window.open('logout.php')"value="logout"></input></p>
<form method="POST">
