...
if(!empty($_POST['Reason']))
{
  ...
  $sql="UPDATE pga  SET approval='Declined', Reason='$Reason '   WHERE ID='$ID'";
...
<br><br><br><br><br><br><br><br><br><br><br>
	...
	$sql="SELECT `photo` from `pga` where ID='$ID' ";
...
<br><br><br><br><br><br><br><br><br><br><br><br><br>    
	...
	$sql="SELECT `document` from `pga` where ID='$ID' ";
    $data=$mysqli->query($sql);
    $result=mysqli_fetch_assoc($data);
    $im="../".$result['document'];
