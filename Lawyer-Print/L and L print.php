...
require('../assets/database/print_sql.php');
  ...
  $ID = secure($_GET['ID']);
  $sql = "SELECT * FROM `leave_and_license_agreement`where ID='$ID'";
...
<head>
    ...
    <title> LEAVE AND LICENCE AGREEMENT  </title>
    <style>
...
<input type="button"  onclick="window.location.href = '../Approval/LL/approve.php?ID=<?php echo $row['ID']; ?>'" value="Approve"></input></form>
<?php
...
<span id="printcontent">
       ...
       THIS LEAVE AND LICENCE AGREEMENT is made, executed and entered into by and between the parties hereto at the place and on the day herein below mentioned.
   ...
   1.	<span id ="witness1"> </span>
   
   
   2.	<span id ="witness2"> </span>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
	...
	$sql="SELECT `photo` from `leave_and_license_agreement` where ID='$ID' ";
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>    
	...
	$sql="SELECT `document` from `leave_and_license_agreement` where ID='$ID' ";
    $data=$mysqli->query($sql);
    $result=mysqli_fetch_assoc($data);
    $im="../".$result['document'];
  ...
  function printDiv() { 
                ...
                <?php  $total =$row['total']; ?>
                <?php  $witness1 =$row['Witness1']; ?>
                <?php  $witness2 =$row['Witness2']; ?>
               ...
               var witness1 = "<?php echo $witness1 ?>";
               var witness2 = "<?php echo $witness2 ?>";
               ...
               document.getElementById("witness1").innerHTML = witness1;
               document.getElementById("witness2").innerHTML = witness2;
