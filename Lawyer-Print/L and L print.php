...
<input type="button" onclick="window.location.href = '../Approval/LL/decline.php?ID=<?php echo $row['ID']; ?>'" value="Decline"></input>
<input type="button"  onclick="window.location.href = '../Approval/LL/approve.php?ID=<?php echo $row['ID']; ?>'"value="Approve"></input>
