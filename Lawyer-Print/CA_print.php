...
<input type="button" onclick="window.location.href = '../Approval/CA/decline ca.php?ID=<?php echo $row['ID']; ?>'" value="Decline"></input>
<input type="button"  onclick="window.location.href = '../Approval/CA/approve ca.php?ID=<?php echo $row['ID']; ?>'"value="Approve"></input>
