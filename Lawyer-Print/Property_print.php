...
<input type="button"  onclick="window.location.href = '../Approval/property/approve property.php?ID=<?php echo $row['ID']; ?>'" value="Approve"></input></form>
<?php
if(!empty($_POST['Reason']))
{
  ...
  $sql="UPDATE property_transfer  SET approval='Declined', Reason='$Reason '   WHERE ID='$ID'";
...
This Agreement to Sale is executed on this  <span id="selling_date"></span> between <b><span id="firstPartyName"></span></b>  having address <span id="firstPartyAddress"></span>at hereinafter called the Party No.1.

AND

<b><span id="secondPartyName"></span></b> having address at <span id="secondPartyAddress"></span>  hereinafter called the Party No.2.
...
<br><br><br><br><br><br><br><br><br><br><br>
	...
	$sql="SELECT `photo` from `property_transfer` where ID='$ID' ";
...
<br><br><br><br><br><br><br><br><br><br><br><br><br>    
	...
	$sql="SELECT `document` from `property_transfer` where ID='$ID' ";
    $data=$mysqli->query($sql);
    $result=mysqli_fetch_assoc($data);
    $im="../".$result['document'];
