...
<!-- database -->
    ...
    { 
        ...
        $sql = "INSERT INTO `PGA`(`email`,`approval`,`firstPartyName`, `firstPartyAddress`, `secondPartyName`, `secondPartyAddress`, `noOfMonths`, `startDate`, `endDate`, `rent`, `rentxmonths`, `deposit`, `total`) VALUES ('$email','$approval','$firstPartyName','$firstPartyAddress','$secondPartyName','$secondPartyAddress','$ContractLength','$LiveDate','$EndDate','$rent','$rentxmonths','$deposit','$total')";
        $mysqli->query($sql);
